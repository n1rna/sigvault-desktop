...
use local_wallet::commands::{
    ...
    cmd_local_create_singlesig_hw, cmd_local_create_timelocked, cmd_local_create_wallet,
    ...
    cmd_local_lock_wallet, cmd_local_recover_cosigner, cmd_local_recover_from_mnemonic,
    cmd_local_set_settings, cmd_local_sign_psbt_hardware, cmd_local_sign_psbt_software,
    cmd_local_sync, cmd_local_unlock_wallet,
};
