...
pub use service::{DeviceInfo, HardwareWalletDevice, HwiService};
...
pub async fn list(
    ...
    let mut hws: Vec<Box<dyn HWI + Send>> = Vec::new();
    ...
    for device_info in api.device_list() {
        ...
        // Skip HID Coldcard if we already found it via simulator socket
